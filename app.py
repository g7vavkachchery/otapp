...
if not df.empty:
    ...
    if st.button("🚀 Generate Filled General 35 A Voucher"):
        try:
            ...
            page.insert_textbox(fitz.Rect(56, 333, 83, 358), req_start_date.strftime("%d/%m/%Y"), fontsize=7, align=fitz.TEXT_ALIGN_LEFT)
            page.insert_textbox(fitz.Rect(88, 333, 113, 358), req_end_date.strftime("%d/%m/%Y"), fontsize=7, align=fitz.TEXT_ALIGN_LEFT)
